                    ...
                    <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                                ...
                                <img src="<?php echo base_url("assets/img/register.jpeg"); ?>"
                                class="img-fluid" style="border-radius: 30px; margin-right:auto; margin-left:auto; width:500px;height:400px " alt="Sample image">
